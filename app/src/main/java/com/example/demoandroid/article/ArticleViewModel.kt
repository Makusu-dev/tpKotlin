...
//            AppAlertHelpers.get().show(response.message)
    ...
    fun getArticleByIdFromApi(id: String){
        ...
        // Affiche un ecran de chargement
        AppProgressHelper.get().show("Chargement de l'article")
        viewModelScope.launch {
            val response = ArticleService.ArticleServiceApi.articleService.getArticleById(id)
            article.value = response.data!!
...
//            AppAlertHelpers.get().show(response.message)
    ...
    fun saveArticle(onLoginSuccess: () -> Unit= {}){
        AppProgressHelper.get().show("Enregistrement de l'article")
        viewModelScope.launch {
    ...
    fun deleteArticle(context: Context, id: String){
        AppProgressHelper.get().show("Suppression de l'article")
